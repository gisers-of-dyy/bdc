    ...
    while True:
        ...
        if (rowIndex % 5 == 0):
            PointAttribute = dict(fruitId= fruitIdTemp, fruitCategoryId = fruitCategoryIdTemp,
                              pointName= tempList[0],pointLevel= tempList[1],
                              highDatum = tempList[2],producDate = tempList[3])
...
def writer(outFileName):
    ...
    newSheet = book.add_sheet(sheetname='水准点整理', cell_overwrite_ok=True)
    ...
    column0 = ["fruitId", "x", "y", "fruitCategoryId", "点名", "等级","高程基准","生产时间"]
    k = 0
...
locationFileName = "D:\Python\ExtractPointInfo\水准点\水准点位置.txt"
attributeFileName = "D:\Python\ExtractPointInfo\水准点\水准点属性.txt"
outFileName = "D:\Python\ExtractPointInfo\水准点\水准点整理.xls"
...
# writer(outFileName)
outFileName1 = "D:\Python\ExtractPointInfo\水准点\ExtractPoint.shp"
